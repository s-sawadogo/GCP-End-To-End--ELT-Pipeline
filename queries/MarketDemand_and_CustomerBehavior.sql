...
FROM `possible-coast-463614-i9.transformed_data.cleaned_and_filtered`
GROUP BY trip_date, year, month, week, weekday
ORDER BY trip_date;

SELECT COUNT(*) FROM `views_fordashboard.demand_over_time`;
...
JOIN `possible-coast-463614-i9.raw_yellowtrips.taxi_zone` z
